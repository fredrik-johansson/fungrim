...
make_entry(ID("bf8f37"),
    ...
    CodeExample(CurvePath(R*Exp(ConstI*t), For(t, 0, 2*Pi)), "Represents the circular path counterclockwise around the origin, starting at", R, "."),
    CodeExample(CurvePath(R*Exp(ConstI*t), For(t, 0, -(2*Pi))), "Represents the circular path clockwise around the origin, starting at", R, "."),
    CodeExample(Path(+Infinity, CurvePath(Exp(ConstI*t), For(t, Pi/2, 3*Pi/2)), +Infinity), "Represents the Hankel contour starting at",
