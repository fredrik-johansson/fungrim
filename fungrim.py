...
writetopic("Barnes G-function", highlight=True)
frontpage.fp.write("""</ul></li>""")
...
writetopic("Riemann hypothesis")
writetopic("Hurwitz zeta function")
...
writetopic("Carlson symmetric elliptic integrals", highlight=True)
frontpage.fp.write("""</ul></li>""")
